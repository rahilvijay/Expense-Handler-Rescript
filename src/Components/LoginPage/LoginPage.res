...
@react.component
let make = (~handleLogin, ~loginState: bool) => {
  let (inputState: LoginState.t, setInputState) = React.useState(_ => LoginState.initial)
  ...
  <form className="login-form" onSubmit={loginSubmitHandler}>
    ...
    <div className="form_controls">
      ...
      <input
        onChange={passwordChangeHandler} id="password" type_="password" placeholder="password"
      />
    </div>
    {!loginState && submitState
      ? <p className="warning-text">
          {"Please Enter correct username or password"->React.string}
        </p>
      : React.null}
